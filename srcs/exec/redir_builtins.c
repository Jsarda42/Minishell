...
int	heredoc_builtins(t_data *data, t_shell *shell, char *eof, char *file_name)
{
	if (!eof)
...
int	redir_out_builtins(t_data *data, t_shell *shell, char *file_name)
{
...
int	appen_redir_out_builtins(t_data *data, t_shell *shell, char *file_name)
{
